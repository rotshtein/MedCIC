...
public class MainScreen {
	...
	public MainScreen() 
	{
		...
		/*
		m = StatusReply.newBuilder()
				.setStatus(STATUS.RUN)
				.setStatusDescription("Seems OK")
				.setError(false)
				.setWarning(false)
				.build();
	...
	class StartAction implements ActionListener
	{
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			lblStatusbar.setText("Protocol=" + Protocol +", FrameSize=" + FrameSize + " CIC1 is " + (chkCic1.isSelected() ? "ON" : "OFF") + ", CIC2 is " + (chkCic2.isSelected() ? "ON" : "OFF") );
			try 
			{
