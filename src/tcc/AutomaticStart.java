...
public class AutomaticStart implements Runnable
{
	...
	public AutomaticStart(GuiInterface gui, String SourceUri, String IdFile, String DestUri, String ConfigFile, String Server, int Port)
	{
		 this.gui = gui;
...
/*	public ProcMon Start(String SampleFilename, String ConfigFile, String Server, int Port) throws Exception
	...
	public void run()
	{
		...
		try
		{
			...
			ProcMon idetifyProcess = idn.Start("C:\\programs\\lego\\config\\IDScript.lego", configFile, managementServer, managementPort);
